...
export class NonfungiblePositionManager extends ethereum.SmartContract {
  ...
  farmingApprovals(param0: BigInt): Address {
    let result = super.call(
      "farmingApprovals",
  ...
  try_farmingApprovals(param0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "farmingApprovals",
      "farmingApprovals(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  positions(tokenId: BigInt): NonfungiblePositionManager__positionsResult {
    let result = super.call(
      "positions",
      "positions(uint256):(uint88,address,address,address,int24,int24,uint128,uint256,uint256,uint128,uint128)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    );
  ...
  tokenFarmedIn(param0: BigInt): Address {
    let result = super.call(
      "tokenFarmedIn",
  ...
  try_tokenFarmedIn(param0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "tokenFarmedIn",
      "tokenFarmedIn(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
