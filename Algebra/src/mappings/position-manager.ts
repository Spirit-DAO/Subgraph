...
import {
  ...
  function getSqrtRatioAtTick(tick: BigInt): BigInt {
	...
	// Initialize ratio with either 1 or the base value depending on the first bit
	let ratio = (absTick.bitAnd(BigInt.fromI32(0x1))).notEqual(ZERO_BI)
	  ? BigInt.fromString('340282366920938463463374607431768211455') // 0xfffcb933bd6fad37aa2d162d1a594001
	  : BigInt.fromString('340282366920938463463374607431768211456') // 0x100000000000000000000000000000000
  
	if (!absTick.bitAnd(BigInt.fromI32(0x2)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374607431589639679')).rightShift(128) // 0xfff97272373d413259a46990580e213a
	if (!absTick.bitAnd(BigInt.fromI32(0x4)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374607431285066684')).rightShift(128) // 0xfff2e50f5f656932ef12357cf3c7fdcc
	if (!absTick.bitAnd(BigInt.fromI32(0x8)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374607430693266672')).rightShift(128) // 0xffe5caca7e10e4e61c3624eaa0941cd0
	if (!absTick.bitAnd(BigInt.fromI32(0x10)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374607429557340740')).rightShift(128) // 0xffcb9843d60f6159c9db58835c926644
	if (!absTick.bitAnd(BigInt.fromI32(0x20)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374607427461105652')).rightShift(128) // 0xff973b41fa98c081472e6896dfb254c0
	if (!absTick.bitAnd(BigInt.fromI32(0x40)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374607423729959009')).rightShift(128) // 0xff2ea16466c96a3843ec78b326b52861
	if (!absTick.bitAnd(BigInt.fromI32(0x80)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374607416774105171')).rightShift(128) // 0xfe5dee046a99a2a811c461f1969c3053
	if (!absTick.bitAnd(BigInt.fromI32(0x100)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374607404327180388')).rightShift(128) // 0xfcbe86c7900a88aedcffc83b479aa3a4
	if (!absTick.bitAnd(BigInt.fromI32(0x200)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374607383317252692')).rightShift(128) // 0xf987a7253ac413176f2b074cf7815e54
	if (!absTick.bitAnd(BigInt.fromI32(0x400)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374607348790353907')).rightShift(128) // 0xf3392b0822b70005940c7a398e4b70f3
	if (!absTick.bitAnd(BigInt.fromI32(0x800)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374607292537260505')).rightShift(128) // 0xe7159475a2c29b7443b29c7fa6e889d9
	if (!absTick.bitAnd(BigInt.fromI32(0x1000)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374607203473078309')).rightShift(128) // 0xd097f3bdfd2022b8845ad8f792aa5825
	if (!absTick.bitAnd(BigInt.fromI32(0x2000)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374607063345262053')).rightShift(128) // 0xa9f746462d870fdf8a65dc1f90e061e5
	if (!absTick.bitAnd(BigInt.fromI32(0x4000)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374606860273541879')).rightShift(128) // 0x70d869a156d2a1b890bb3df62baf32f7
	if (!absTick.bitAnd(BigInt.fromI32(0x8000)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374606619707236278')).rightShift(128) // 0x31be135f97d08fd981231505542fcfa6
	if (!absTick.bitAnd(BigInt.fromI32(0x10000)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374606471333169337')).rightShift(128) // 0x9aa508b5b7a84e1c677de54f3e99bc9
	if (!absTick.bitAnd(BigInt.fromI32(0x20000)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374606397105460740')).rightShift(128) // 0x5d6af8dedb81196699c329225ee604
	if (!absTick.bitAnd(BigInt.fromI32(0x40000)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374606360489160344')).rightShift(128) // 0x2216e584f5fa1ea926041bedfe98
	if (!absTick.bitAnd(BigInt.fromI32(0x80000)).equals(ZERO_BI))
	  ratio = ratio.times(BigInt.fromString('340282366920938463463374606342928920098')).rightShift(128) // 0x48a170391f7dc42444e8fa2
  
	if (tick.gt(BigInt.zero())) {
	  ratio = BigInt.fromString('340282366920938463463374607431768211455').div(ratio) // max uint256
	}
  ...
  function savePositionSnapshot(position: Position, event: ethereum.Event): void {
	...
	positionSnapshot.tickLower = tickLower
	positionSnapshot.tickUpper = tickUpper
